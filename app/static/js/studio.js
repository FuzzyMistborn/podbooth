...
const timerThresholdsEl = document.getElementById('timer-thresholds');
const timerQueueEl  = document.getElementById('timer-queue-list');
const btnTimerAddTrigger = document.getElementById('btn-timer-add-trigger');
const timerAddFormEl = document.getElementById('timer-add-form');
